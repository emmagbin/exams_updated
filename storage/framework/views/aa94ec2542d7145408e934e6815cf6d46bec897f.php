 ...
 ?>
	<div id="wrapper" class="<?php echo e($class); ?>">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li <?php echo e(isActive($active_class, 'dashboard')); ?>> 
					...
					<li <?php echo e(isActive($active_class, 'performance')); ?> >

						<a data-toggle="collapse" data-target="#reports"><i class="fa fa-fw fa-align-justify "></i>
							<?php echo e(getPhrase('performance')); ?> </a>

						<ul id="performance" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_STUDENT_PERFORMANCE); ?>"> <i class="fa fa-fw fa-user"></i><?php echo e(getPhrase('students')); ?></a></li>
